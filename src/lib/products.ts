...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Impresora Brother HL-L2370DW",
    description: "Impresora láser monocromática con WiFi y dúplex automático. Velocidad 36ppm. Tóner de alto rendimiento incluido (nuevo, 3000 páginas). Perfecta para oficina en casa o pequeña empresa.",
    price: 195000,
    condition: "muy-buen-estado",
    conditionLabel: "Muy buen estado",
    conditionDescription: "Poco uso, contador marca ~5000 páginas. Imprime perfecto, sin líneas ni manchas. WiFi funcionando correctamente. Se entrega con tóner nuevo compatible de 3000 páginas.",
    stock: 1,
    images: [
