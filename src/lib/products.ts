...
export const products: Product[] = [
  ...
  },
  {
    ...
    stock: 1,
    images: [
      "/images/impresora-brother/impresora_brother_cb_jamstack_agency_myshop usada barata.jpg",
      "/images/impresora-brother/impresora usada regalo cartucho.jpg",
      "/images/impresora-brother/impresora_brother cartuchos regalo barato usado.jpg",
